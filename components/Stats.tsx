           ...
           {[
             ...
             >
                ...
                <div className="relative z-10 preserve-3d">
                  ...
                  <p className="text-gray-500 font-medium leading-relaxed" style={{ transform: "translateZ(10px)" }}>
                    {stat.desc}
                  </p>
                </div>
                
                {/* 3D Bar Chart Visual */}
                <div className="absolute bottom-0 left-0 w-full h-32 px-10 flex items-end justify-center pointer-events-none opacity-20 group-hover:opacity-30 transition-opacity">
                    <motion.div 
                        initial={{ height: 0 }}
